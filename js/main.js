const POLICIES_DATA = [
    ...
    },
    {
        ...
        highlight: "發揮 30 年資工數據專長，向交通局爭取明德路二段綠波續進與學府路口行人時相優化，並建立危險路點資料庫爭取步道改善。",
        ...
        description: "明德里的交通痛點不能只靠口號！從學府路口的轉彎車卡死、學士路往金城路的號誌不同步連環回堵，到長輩學童的通學步道安全，我們運用資工大數據思維，向市府交通局與交控中心精準建言，讓人行安心、車行順暢。",
        howToDo: [
            "【幹道智慧動態綠波】：向交通局交控中心調閱車流秒數，爭取明德路二段與學士路、金城路口「綠波續進 (Green Wave)」，終結前後號誌打架的連環塞車。",
            "【尖峰行人專用時相】：爭取明德／學府路口尖峰時段擴大「全向行人專用時相」並導入「行人早開時相 (LPI)」，人車徹底分流，轉彎車不再被卡死。",
            "【步行危險點數據化會勘】：提供里民線上線下回報平台，建立「社區步行危險點資料庫」，排定會勘爭取樂利國小通學路徑綠底人行道與防滑鋪面。"
        ],
...
const DEFAULT_QA_DATA = [
    {
        ...
        response: "1. 【已規劃於政見白皮書第 4 案】：塞車之苦新昱與所有里民感同身受！這也是我自己每天出門的真實困擾，已正式列入「智慧交通與友善步行」核心政見。\n2. 【專業解析與學府路口解方】：\n　• 兩者差別：「全向行人專用時相」是全路口車輛全紅燈，行人專屬安心過，人車 100% 徹底分流；而「早開時相」只是行人提早幾秒綠燈，車輛轉彎依然會卡在行人隊伍中，白天車多時早開毫無效用、第一輛車依舊塞死整條路！\n　• 具體方案：當選後將在最短時間內向交通局爭取白天與上下班尖峰大幅延長「全向行人專用時相」，讓車輛綠燈轉彎零阻礙順暢通行；「早開時相」則僅保留於車流稀少的離峰與深夜時段。\n3. 【學士路口往金城路智慧綠波】：前後紅綠燈打架是號誌沒有連鎖！新昱具備 30 年資工數據專長，將直接調閱交通局交控中心秒數，爭取幹道「綠波續進 (Green Wave)」，一路順暢不再原地苦等！"
    },
    {
        id: "qa-2",
        category: "#跨世代共融與課程",
