...
const POLICIES_DATA = [
    ...
    },
    {
        ...
        howToDo: [
            "【重要便道與通學廊道搶險固化】：借鏡 403 地震成功協調權責機關搶通「捷運學府與孔雀王朝二期」下陷便道之實戰經驗，主動破除機關互推延宕，確保危險便道第一時間修復固化。",
            "【全里人行危險點大數據資料庫】：線上彙整地不平、照明昏暗、視線死角與積水路段，依急迫性排定會勘改善。",
            "【騎樓順平與轉角視線優化】：推動騎樓高低差順平，並爭取重要巷口標線改善，消除轉彎視線盲區。"
        ],
        whyPossible: "候選人具備實戰協調經驗，曾於 403 地震後在各單位束手無策互推責任下，深入研究並成功找到權責機關配合施工搶通捷運學府與孔雀王朝二期下陷便道；長期擔任校園志工與 10 年管委會實務，深諳公門運作，能以數據與法規精準向市府爭取專案改善預算。",
        ...
        sections: [
            {
                title: '🌟 還沒上任就有政績',
                items: [
                    { label: '403 地震行人便道下陷危機', text: '403 地震造成捷運學府與孔雀二期之間便道下陷坍塌，因涉及多機關管轄邊界而陷入停滯；經我深入研究法規與產權、精準鎖定權責單位促成進場搶通，守護鄰里長幼與視障朋友的通行安全。', btnText: '查看詳情', drawerId: 14 },
                    { label: '反濫訴防禦社區規約', text: '擔任主委期間建立「反濫訴防禦社區規約」，濫訴者需負擔被濫訴人的損害賠償含律師費並獲法院判決勝訴，解決社區住戶經常被濫訴的困擾', btnText: '查看詳情', drawerId: 10 }
                ]
            },
            {
                title: '💡 痛點問題與重點關懷：',
