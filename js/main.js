        ...
        sections: [
            {
                ...
                items: [
                    { label: '8年樂利EQ志工組長', text: '取得 7 套專業情緒教育證照，帶領 70 位志工入班陪伴學童' },
                    { label: '首創規約制裁惡意濫訴', text: '學EQ不是吞委屈，生氣可被理解，面對真正霸凌有足夠智慧與勇氣迎戰！' },
                    { label: '6年補救教學與4年故事爸爸', text: '耐心陪伴進度較慢的孩子，每週說故事啟發想像力' }
                ]
            },
            {
                title: '🌟 核心承諾：',
                items: [
                    { label: '專業同理溝通', text: '耐心傾聽修繕與住戶歧見，用溫暖對話化解鄰里糾紛' },
                    { label: '開辦家庭EQ工作坊', text: '結合社區資源協助家長建立良好跨世代親子溝通' }
                ]
            },
            {
                title: '💡 痛點問題與重點關懷：',
        ...
        sections: [
            {
                ...
                items: [
                    ...
                    { label: '首創規約遏止鄰里濫訴', text: '合理訴訟是基本人權，不合理濫訴就是霸凌！運用住宅法規守護安寧' },
                    { label: '掌握交通照明死角與清淤', text: '盤點昏暗死角，定期巡查清淤防範暴雨積水' }
                ]
            },
            {
                title: '🌟 核心承諾：',
