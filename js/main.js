const POLICIES_DATA = [
    {
        ...
        budgetSource: "社區營造與藝文推廣專案補助",
        budgetSub: "（完全不用動到明德里近百萬基層款）",
        budgetDesc: "本活動依法向市府申請「社區營造與藝文推廣專案補助」或參與式預算，由藝文專款補助舞台音響與演出師資，完全不排擠里內既有的近百萬基層工程款！",
    ...
    },
    {
        ...
        budgetSource: "社區教育多元學習專案 ✕ 專業志工共創",
        budgetSub: "（完全不用動到明德里近百萬基層款）",
        budgetDesc: "結合候選人 8 年 EQ 志工組長師資團隊與專業協會現成教材，並對接社區多元學習專案補助，以極低成本甚至零公帑為里民開辦高品質工作坊。",
    ...
    },
    {
        ...
        budgetSource: "青年科技科普培力專案 ✕ 科技志工跨界",
        budgetSub: "（完全不用動到明德里近百萬基層款）",
        budgetDesc: "候選人運用 30 年科技管理背景自帶設備與師資社群，並爭取青年創育與科普活動專案補助，讓里內孩子免費或以極低耗材費體驗先進科技。",
    ...
    },
    {
        ...
        budgetSub: "（完全不用動到明德里近百萬基層款）",
        budgetDesc: "本案屬於政府交通與工務單位之法定道路維護權責，由科技里長提供精準車流與號誌數據進行跨局處會勘，直接由市府專案工程款發包施作，零花費里辦公處預算！",
    ...
    },
    {
        ...
        budgetSource: "明德里基層工作經費 ✕ 科技經理人自研維運",
        budgetSub: "（使用每年近百萬基層款，零額外自費）",
        budgetDesc: "本系統由候選人發揮軟體架構長才自主開發建置，日常伺服器與維運成本極低，由每年近百萬的「里基層工作經費」依法編列雜支即可輕鬆支應。",
    ...
    },
    {
        ...
        highlight: "開設實用 AI 健康工作坊，對接衛福部 62.5 億獨老安危專案，導入主式福利媒合、物資智慧適配與居家緊急防跌，讓三明治世代安心工作。",
