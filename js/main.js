const POLICIES_DATA = [
    {
        ...
        budgetSource: "新北市文化局社造專案補助（零動用里基層款）",
        budgetDesc: "本活動依法向新北市文化局申請「社區營造與藝文推廣專案補助」或市府參與式預算，由文化局專款補助舞台音響與演出師資，完全不排擠里內既有的近百萬基層工程款！",
    ...
    },
    {
        ...
        budgetSource: "新北市教育局社教專案 / 民間專業志工共創（零動用里基層款）",
        budgetDesc: "結合候選人 8 年 EQ 志工組長師資團隊與專業協會現成教材，並對接教育局社區多元學習補助，以極低成本甚至零公帑為里民開辦高品質工作坊。",
    ...
    },
    {
        ...
        budgetSource: "民間科技志工跨界合作 / 新北市青年局培力專案（零動用里基層款）",
        budgetDesc: "候選人運用 30 年科技管理背景自帶設備與師資社群，並爭取新北市青年局與科技部科普活動專案補助，讓里內孩子免費或以極低耗材費體驗先進科技。",
    ...
    },
    {
        ...
        title: "智慧交通與友善步行",
        subtitle: "向市府爭取幹道綠波續進　數據化打造安全通行路網",
        image: "images/policy_04_safety_2.png",
        budgetSource: "新北市交通局動態綠波專案 / 工務局道路會勘工程款（零動用里基層款）",
        budgetDesc: "本案屬於新北市政府交通局與工務局之法定道路維護權責，由科技里長提供精準車流與號誌數據進行跨局處會勘，直接由市府專案工程款發包施作，零花費里辦公處預算！",
        highlight: "發揮 30 年資工數據專長，向交通局爭取明德路二段全廊道動態綠波與學府路口全向行人時相優化，並建立危險路點資料庫爭取步道改善。",
        ...
        description: "明德里的交通痛點不能只靠口號！明德路二段從海山路口（台中銀行）、學府路口（新北高工）、學士路口到金城路口，是全里車流進出的主要動脈，四大路口號誌環環相扣。從學府路轉彎車被停讓行人卡死、學士路往金城路號誌不同步的連環回堵，到學童通學步道安全，我們運用 30 年資工大數據思維，向市府交通局精準建言，落實人車分流與全廊道號誌連鎖！",
        howToDo: [
            "【學府路口（新北高工）人車徹底分流】：向交通局爭取日間與尖峰全時段採用「全向行人專用時相」，行人專屬安心過，綠燈轉彎車零阻礙順暢通行；「早開時相」則保留於深夜車流稀少時段。",
            "【明德路二段全廊道動態綠波】：針對海山路口至金城路口四節點，調閱交控中心時制秒數，爭取幹道「動態綠波續進 (Green Wave)」，串聯號誌連鎖，消除紅綠燈打架回堵。",
            "【樂利國小通學步道數據化會勘】：建立里民步行危險點資料庫，排定會勘爭取樂利國小周邊通學步道綠底標線與防滑鋪面，保障長者與學童安全。"
        ],
    ...
    },
    {
        ...
        categoryName: "空間活化與民生活主",
        title: "數位里政與參與式治理",
        subtitle: "24小時 AI 里政客服 ‧ 主動式福利篩檢與代辦諮詢",
        image: "images/policy_05_guide.png",
        budgetSource: "新北市里基層工作經費 / 科技經理人自主研發維運",
        budgetDesc: "本系統由候選人發揮軟體架構長才自主開發建置，日常伺服器與維運成本極低，由每年近百萬的「新北市里基層工作經費」依法編列雜支即可輕鬆支應。",
        highlight: "建立 24 小時數位里政窗口與會勘透明機制，開辦「主動式福利篩檢與代辦諮詢」，主動協助里民把應得津貼與補助一次辦到位。",
    ...
    },
    {
        ...
        budgetSource: "新北市里基層工作經費 / 流行音樂產業師資協作",
    ...
    },
    {
        ...
        title: "AI 全天候健康管家與獨老安危防護",
        subtitle: "讓 AI 成為健康隨身管家 ‧ 對接國家長照資源守護長者安危",
        image: "images/policy_07_health.png",
        budgetSource: "中央衛福部 62.5 億獨老安居專案 / 長照 2.0（零動用里基層款）",
        budgetDesc: "本案直接對接中央衛生福利部「擴大獨老在宅安居計畫」及新北市社會局長照專款，協助長者申請公費「緊急救援防跌系統」，由中央與市府全額或高額補助！",
    ...
    },
    {
        ...
        subtitle: "用互動科技活化大腦刺激 ‧ 主動對接身障與長照喘息資源",
        image: "images/policy_08_brain.png",
        budgetSource: "衛福部失智防護專案 / 國民健康署社區健康促進專案（零動用里基層款）",
        budgetDesc: "結合衛福部失智友善社區專案及國健署長者健康促進補助，引進臨床驗證的健腦 App 與教具，由專案補助支應，完全不佔用里內修繕費用。",
    ...
    },
    {
        ...
        budgetSource: "新北市市民活動中心活化專案 / 里基層工作經費",
        budgetDesc: "本案運用明德市民活動中心既有公有設施，以市府活動中心專案活化補助及每年「里基層工作經費」水電補助支應，零額外負擔落實全齡共享。",
    ...
    },
    {
        ...
        budgetSource: "競選團隊專業律師與調解志工公益支援（零花費）",
    ...
    },
    {
        ...
        budgetSource: "新北市里基層工作經費 / 新北市動保處推廣專案",
        budgetDesc: "便攜袋補充站與清潔箱採購由每年「里基層工作經費」支應（每座僅數百至千餘元），並結合動保處宣導品與民間志工共同維護，經濟實惠又乾淨。",
    ...
    },
    {
        ...
        budgetSource: "新北市青年局與社會局人才培力專案 / 里基層工作經費",
        budgetDesc: "提供市民活動中心免租金場地，對接青年局青年創育與社會局社區互助補助，以極低成本為社區搭建斜槓展演舞台，形成良性人才生態！",
...
function openDrawer(policyId) {
    ...
    if (budgetBadgeEl) budgetBadgeEl.textContent = policy.budgetSource || '新北市里基層工作經費';
    const budgetTextEl = document.getElementById('drawer-budget-text');
    if (budgetTextEl) budgetTextEl.textContent = policy.budgetDesc || '由新北市政府相關公務預算依法支應。';
