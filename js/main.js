...
const POLICIES_DATA = [
    ...
    },
    {
        ...
        subtitle: "天京、孔雀一期與捷運學府部分騎樓無防滑，孔雀二期騎樓破損！",
        ...
        hooks: [
            "<span class=\"hl-keyword\">天京社區</span>與<span class=\"hl-keyword\">孔雀一期</span>騎樓為全聯採買、捷運通勤與就學要道，部分鋪面無防滑設計，雨天行人與長輩步步驚心；<span class=\"hl-keyword\">孔雀二期</span>部分騎樓地磚破損，更增加推車卡阻與長輩跌倒風險！"
        ],
        howToDo: [
            "【高摩擦防滑速效解方】：針對天京、孔雀一期與捷運學府等通勤要道，花費極少經費推動高摩擦防滑塗料或防滑貼條試辦，雨天立即見效。",
            "【爭取市府騎樓整平專案】：針對孔雀二期破損地磚與高低差，主動對接市府工務局「騎樓整平計畫」專案會勘，由政府出資更新防滑鋪面，零排擠社區負擔。",
            "【無障礙順平與通行防護】：改善嬰兒車、輪椅通行障礙與視障動線盲區；及時消除公共通行危險，既保障長幼通行，也為社區防範民法損害賠償風險。"
        ],
        whyPossible: "候選人<span class=\"hl-keyword\">懂法規、善協調、深諳公門運作</span>，擁有 10 年管委會實戰經驗；曾於 403 地震後深入研究法規產權，<span class=\"hl-keyword\">成功協調權責機關跨局處施工</span>，搶通解決三不管重要便道下陷與行人安全問題。"
    },
    {
        id: 4,
        category: "democracy",
