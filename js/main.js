const POLICIES_DATA = [
    ...
    },
    {
        ...
        highlight: "開設實用 AI 健康工作坊，對接衛福部 62.5 億獨老安危專案，導入物資智慧適配與居家緊急防跌，讓三明治世代安心工作。",
        ...
        description: "里政關懷不只送暖，更要送對與確認安危！我們結合 30 年資工數據專長，對接衛福部擴大獨老安居照護專案，引進 AI 智慧物資適配（避開慢性病長者飲食禁忌）與公費居家緊急救援防跌系統，讓外地與白天上班的三明治世代無後顧之憂。",
        howToDo: [
