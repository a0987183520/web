...
const POLICIES_DATA = [
    {
        id: 1,
        title: "民歌Live草地音樂節",
        subtitle: "<span class=\"hl-subtitle-green\">邀請歌手吉他彈唱互動</span>，春秋兩季相約活動中心<span class=\"hl-subtitle-green\">草地野餐</span>，用音樂找回與鄰居的連結",
    ...
    },
    {
        ...
        title: "智慧交通號誌 ＋ 解決塞車問題",
        subtitle: "海山、學府、學士路口<span class=\"hl-subtitle-green\">紅綠燈不同步</span>，爭取<span class=\"hl-subtitle-green\">動態綠波</span>與<span class=\"hl-subtitle-green\">行人專用時相</span>，告別塞車！",
    ...
    },
    {
        ...
        title: "微型遙控車 ＋ 微型無人機",
        subtitle: "<span class=\"hl-subtitle-green\">誰說長輩不能飛</span>？從地面微型遙控車輕鬆起步，進階無人機飛行體驗，全齡手眼協調延緩退化！",
    ...
    },
    {
        ...
        title: "獨老或雙老暖心居家照護",
        subtitle: "對接<span class=\"hl-subtitle-green\">衛福部 62.5 億專案</span>，獨老與雙老同住皆可申請！建立 24 小時公費防跌守護網，為三明治世代守住全家平安！",
    ...
    },
    {
        ...
        subtitle: "自研 1 至 50 健腦遊戲每天動態預警，結合 <span class=\"hl-subtitle-green\">AI 短劇</span>與<span class=\"hl-subtitle-green\">老照片修復</span>，全方位延緩大腦退化！",
    ...
    },
    {
        ...
        title: "銀髮共餐2.0 ＋ 全民灶咖",
        subtitle: "用餐前、後志工帶領趣味小遊戲，<span class=\"hl-subtitle-green\">全民灶咖</span>發揮創意，重拾親子與鄰里情感！",
    ...
    },
    {
        ...
        subtitle: "你們是否有遇過喜歡<span class=\"hl-subtitle-green\">濫訴的鄰居</span>，漏水責任問題，噪音如何處理？",
    ...
    },
    {
        ...
        categoryName: "生活美學與未來教育",
        title: "斜槓人才招募計畫",
        subtitle: "故事媽媽、EQ爸爸、園藝達人到 AI 短劇高手，<span class=\"hl-subtitle-green\">招募</span>鄰里微專長的<span class=\"hl-subtitle-green\">斜槓人才</span>！",
    ...
    },
    {
        ...
        subtitle: "太鼓與舞蹈班...等舊課程安心延續。流行樂團背景陪襯，<span class=\"hl-subtitle-green\">祖孫同台不是夢</span>",
    ...
    },
    {
        ...
        subtitle: "廚房廢油是<span class=\"hl-subtitle-green\">堵塞水管的元兇</span>，將廢油做成手工皂，省錢更環保",
    ...
    },
    {
        ...
        image: "images/policy_15_pet.png?v=32.01",
...
function openDrawer(policyId) {
    ...
    if (drawerImgWrapper) {
        ...
        if (policy.id === 14) {
            ...
            // 如果是計畫 15 (寵物友善)，置頂溫馨概念示意圖，下方接 YouTube 衛教宣導影片
            drawerImgWrapper.style.display = 'block';
            drawerImgWrapper.innerHTML = `
                <div style="position: relative; border-radius: 16px; overflow: hidden; border: 1px solid var(--card-border); margin-bottom: 1.5rem;">
