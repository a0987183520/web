const POLICIES_DATA = [
    ...
    },
    {
        ...
        highlight: "發揮 30 年資工數據專長，向交通局爭取明德路二段綠波續進與學府路口全向行人時相優化，並建立危險路點資料庫爭取步道改善。",
        ...
        description: "明德里的交通痛點不能只靠口號！塞車之苦所有里民都感同身受。從學府路口轉彎車被停讓行人卡死、學士路往金城路號誌不同步的連環回堵，到學童通學步道安全，我們運用資工大數據思維，向市府交通局精準建言，落實人車分流與號誌連鎖！",
        howToDo: [
            "【學府路口人車徹底分流】：向交通局爭取日間與尖峰全時段採用「全向行人專用時相」，行人專屬安心過，綠燈轉彎車零阻礙順暢通行；「早開時相」則回歸初衷，僅保留於深夜車流稀少時段。",
            "【學士路往金城路動態綠波】：前後紅綠燈打架是號誌缺乏連鎖！調閱交控中心時制秒數數據，爭取明德路二段幹道「綠波續進 (Green Wave)」，一路順暢不再原地苦等。",
            "【通學步道數據化會勘】：建立里民步行危險點資料庫，排定會勘爭取樂利國小周邊通學步道綠底標線與防滑鋪面，保障長者與學童安全。"
        ],
...
const DEFAULT_QA_DATA = [
    ...
    },
    {
        ...
        author: "樂利國小 家長",
        date: "2026-08-12",
        title: "聽說樂利國小的 EQ 課很有名，但為什麼我的小孩沒有上到 EQ 課呢？",
    ...
    },
    {
        ...
        author: "美麗宏國 社區長者",
        date: "2026-08-10",
        title: "常聽候選人提到 AI 健康管家可以幫忙記血壓和提醒吃藥，我們年紀大不會用複雜的手機，號稱科技里長有辦法解決這個問題嗎？",
    ...
    },
    {
        ...
        author: "三明治家庭 照顧者里民",
        date: "2026-08-08",
        title: "我家有一位失智長輩，我上有老、下有小，耐心常常會被消磨殆盡，你的失智 App 真的有用處嗎？我很懷疑？",
        question: "我家有一位失智長輩，我上有老、下有小，每天照顧耐心常常會被消磨殆盡，你的失智 App 真的有用處嗎？我很懷疑？",
        response: "1. 【客觀釐清：App 是認知刺激工具，非醫療特效藥】：AI 腦力健能 App 的核心功能在於「初期認知活化、延緩退化與增加趣味互動」，絕不能取代正規醫療與中重度失智的專業長照。\n2. 【很多人不知道：阿茲海默已符合身障與長照標準】：國家有非常龐大的長照人力、喘息服務、日間照顧與身障生活補助（每月約 4,049 元），本該是三明治世代最堅實的後盾！但若沒有懂法規、懂資源的專業里長主動引路，許多家庭往往只能一人苦撐，讓應得的權益與政府的貼心悄悄溜走。\n3. 【里辦公處主動對接長照與喘息資源】：陳新昱將在里辦公處建立「主動式長照與身障綠色窗口」，主動協助家屬完成身障評估送件、申請市府居服與喘息服務補助，實質分擔照顧重擔，讓您有喘息空間，不再孤軍奮戰。\n4. 【三明治世代照顧者的 EQ 情緒後盾】：身為 8 年 EQ 情緒講師，我非常理解夾心世代長期照護的心理耗損。里辦公處將開辦「照顧者情緒減壓與心理支持工作坊」，提供合法管道與同理傾聽，陪伴您走出情緒孤島。\n5. 【促進跨世代破冰】：App 最大的實質幫助在於將枯燥的復健轉化為「祖孫趣味電競與記憶遊戲」，降低長輩抗拒感，讓孩子願意主動陪伴長輩。"
    },
    {
        id: "qa-7",
        category: "#跨世代共融與課程",
        ...
        author: "學府路 家長 吳先生",
        date: "2026-08-05",
        title: "看到文宣中有無人機與 AI 體驗課，請問小朋友幾歲可以參加？室內操作會不會有安全顧慮？",
